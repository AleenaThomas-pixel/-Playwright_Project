...
- generic [active] [ref=f3e1]:
  ...
  - generic [ref=f3e31]:
    - generic [ref=f3e34]:
      - heading "About Us" [level=4] [ref=f3e35]
      - paragraph [ref=f3e36]: We believe performance needs to be validated at every stage of the software development cycle and our open source compatible, massively scalable platform makes that a reality.
    - generic [ref=f3e39]:
      - heading "Get in Touch" [level=4] [ref=f3e40]
      - paragraph [ref=f3e41]: "Address: 2390 El Camino Real"
      - paragraph [ref=f3e42]: "Phone: +440 123456"
      - paragraph [ref=f3e43]: "Email: demo@blazemeter.com"
    - heading "PRODUCT STORE" [level=4] [ref=f3e47]
  - contentinfo [ref=f3e49]:
    - paragraph [ref=f3e50]: Copyright © Product Store
```
