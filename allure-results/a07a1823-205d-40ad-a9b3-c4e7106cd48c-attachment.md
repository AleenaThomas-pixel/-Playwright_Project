...
```
Error: locator.click: Error: strict mode violation: getByRole('link', { name: 'Samsung galaxy s7' }) resolved to 2 elements:
...
Call log:
  - waiting for getByRole('link', { name: 'Samsung galaxy s7' })
