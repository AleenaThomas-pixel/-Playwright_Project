    ...
    - generic [ref=f5e23]:
      ...
      - table [ref=f5e26]:
        ...
        - rowgroup [ref=f5e33]:
          ...
          - row [ref=f5e48]:
            - cell [ref=f5e49]
            - cell "ASUS Full HD" [ref=f5e51]
            - cell "230" [ref=f5e52]
            - cell [ref=f5e53]:
              - link "Delete" [ref=f5e54] [cursor=pointer]:
                - /url: "#"
    - generic [ref=f5e55]:
      - heading "Total" [level=2] [ref=f5e56]
      - heading "1820" [level=3] [ref=f5e59]
      - button "Place Order" [active] [ref=f5e60]
  - generic [ref=f5e62]:
    - generic [ref=f5e65]:
      - heading "About Us" [level=4] [ref=f5e66]
      - paragraph [ref=f5e67]: We believe performance needs to be validated at every stage of the software development cycle and our open source compatible, massively scalable platform makes that a reality.
    - generic [ref=f5e70]:
      - heading "Get in Touch" [level=4] [ref=f5e71]
      - paragraph [ref=f5e72]: "Address: 2390 El Camino Real"
      - paragraph [ref=f5e73]: "Phone: +440 123456"
      - paragraph [ref=f5e74]: "Email: demo@blazemeter.com"
    - heading "PRODUCT STORE" [level=4] [ref=f5e78]
  - contentinfo [ref=f5e80]:
    - paragraph [ref=f5e81]: Copyright © Product Store
```
